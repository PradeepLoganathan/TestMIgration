...
using testmigration.Models.AccountViewModels;
...
namespace testmigration.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(model.Email,"Confirm your account",
                        $"Please confirm your account by clicking this link: <a href='{callbackUrl}'>link</a>",(int)ENUM.EmailMessageType.UserEmailIdVerify);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "Reset Password",
                   $"Please reset your password by clicking here: <a href='{callbackUrl}'>link</a>",(int)ENUM.EmailMessageType.ForgetPassword);
                return View("ForgotPasswordConfirmation");
            }
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            {
                await _emailSender.SendEmailAsync(await _userManager.GetEmailAsync(user), await _userManager.GetUserNameAsync(user),"Security Code", message,(int)ENUM.EmailMessageType.TwoFactorAuth);
            }
        ...
        //    if (user == null)
        //    {
        //        return RedirectToAction(nameof(AccountController.TestPage1), "Account");
        //    }
        //    else
        //    {
        //        return RedirectToAction(nameof(AccountController.TestPage), "Account");
        //    }
        //    return View();
        //}
        [HttpGet]
        ...
        public async Task<IActionResult> TestPage()
        {
            ...
            if (user == null)
            {
                ViewData["StatusMessage"] = "1";
            }
            else
            {
                ViewData["StatusMessage"] = "2";
            }
            return View();
        }
